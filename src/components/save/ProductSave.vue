<template>
    <div class="modal-backdrop">
      <div class="modal">
        ...
        <br />  
    <button class="button2 " v-on:click="saveProduct">Save</button>  
    ...
    async saveProduct(){
  const {status,data} = await axios.post('http://localhost/basic/web/index.php/products/add-products', this.form)
    if (status === 200){
      alert('Saved', data)
    }
